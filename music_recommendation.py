...
Original file is located at
    https://colab.research.google.com/drive/1KoIIXBZBROAMIeMf3zPQKvg2jxfEUzCP
...
cluster_pipeline = Pipeline([('scaler', StandardScaler()), ('kmeans', KMeans(n_clusters=10, tol=-1))])
...
recommend_songs([{'name': 'Life is a Highway - From "Cars"', 'year': 2009, 'artists': "['Rascal Flatts']"},
                 ...
                 {'name': "Breakfast At Tiffany's", 'year': 1995, 'artists': "['Deep Blue Something']"}], data)